#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#  python/ebola_preinit.py Author "Nathan Wycoff <nathanbrwycoff@gmail.com>" Date 07.18.2019

# Fit a GAN, pretraining
import keras
import numpy as np
...
gen.compile(tf.train.GradientDescentOptimizer(learning_rate = 0.001), 'binary_crossentropy')
disc.compile(tf.train.GradientDescentOptimizer(learning_rate = 0.001), 'binary_crossentropy')
epochs = 600000
