#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#  python/oneconv.py Author "Nathan Wycoff <nathanbrwycoff@gmail.com>" Date 06.14.2019
...
generator = keras.Sequential([
    keras.layers.Dense(128, activation=tf.nn.relu, input_shape = (x_dim+noise_dim,)),
...
discriminator = keras.Sequential([
    keras.layers.Dense(1, input_shape = (D*x_dim+y_dim,), activation = tf.nn.sigmoid)
])
